...
<!-- end header -->
	...
	<div id="cnt1"><div class="post">
		  <h1 align="center" class="title">&nbsp;</h1>
				<h1 align="center" class="title"><a href="#" class="style1">Click name to enter</a></h1>
				<p class="byline"></p>
				<div class="entry">
<?php
include("Connect.php");
...
$b=$students["Name"];
	echo '<tr>';
	echo "<td width='180'>{$students['Admno']}</td>";	
	echo "<td><a href='addmark.php?Admno=$a&TermId=$termid'>$b</a></td>";		//pass admno and term id to addmark
