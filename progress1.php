...
<div id="header">
	<div id="menu">
		<ul id="main">
			...
			<li><a href="progress.php">BACK</a></li>
...
<!-- end header -->
	...
	<div id="cnt1"><div class="post">
		  <h1 align="center" class="title">&nbsp;</h1>
				<h1 align="center" class="title"><a href="#" class="style1">Click name to print</a></h1>
				<p class="byline"></p>
				<div class="entry">
<?php
include("Connect.php");
...
$b=$students["Name"];
	...
	echo "<td><a href='report.php?Admno=$a & TermId=$t'>$b</a></td>"; 		//pass the selected student admno and term id to report page
