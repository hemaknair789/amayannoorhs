			...
			<li><a href="faculty.php">FACULTY</a></li>
			 <li>
			   <div id="horizontalmenu">
                               <ul><li class="current_page_item"><a href="#">FACILITIES</a>
 ...
 <ul>
  ...
  <p>&nbsp;</p>
		...
		<div id="content">
		  ...
		  <div class="post">
				<h1 class="title" align="center"><a href="#">Library</a></h1>
				<p class="byline"></p>
			<div class="entry">
					<img src="images/lib.jpg" width="530" height="197" />
					<p>&nbsp;</p>
                    <span class="style8">The school has a good library with many sorts of reading materials.The library is a welcoming place for study and reading. It is to support the students and teachers by providing access to current, adequate and appropriate information resources. It is also to ensure that all the students, teachers and staff are effectively using the ideas and information. 		    </span></div>
