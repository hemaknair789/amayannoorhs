 ...
 <ul>
  ...
  <p>&nbsp;</p>
		...
		<div id="content">
		  ...
		  <div class="post">
				<h1 class="title" align="center"><a href="#">School Bus</a></h1>
				<p class="byline"></p>
			<div class="entry">
					<img src="images/bus.jpg" width="530" height="197" />
					<p>&nbsp;</p>
                    <span class="style8">The School Transport Scheme supports transport to and from school for students residing far and near the school.		    </span></div>
