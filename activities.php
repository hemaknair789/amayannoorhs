 ...
 <ul>
  ...
  <p>&nbsp;</p>
		...
		<div id="content">
		  ...
		  <div class="post">
				<h1 class="title" align="center"><a href="#">Activities</a></h1>
				<p class="byline"></p>
			<div class="entry">
				<p align="center" class="style7">NCC</p>
					<img src="images/ncc.png" width="530" height="197" />
					<p>&nbsp;</p>
                    <span class="style8"> It is open to students on voluntary basis. It is a voluntary organization which recruits cadets from high schools, colleges and universities all over India. The Cadets are given basic military training in small arms and parades. Camps are conducted for students.		    </span></div>
  ...
  include("Connect.php");
//$id = $_SESSION['din'];
$query = "select * from news where Status='Active'";	//to display latest news
