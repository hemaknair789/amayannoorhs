...
<!-- end header -->
	...
	<div id="cnt1"><div class="post">
		  <h1 align="center" class="title">&nbsp;</h1>
				<h1 align="center" class="title"><a href="#" class="style1">Search</a></h1>
				<p class="byline"></p>
				<div class="entry">
...
echo "<table align='right' width='500' border='2'>
<tr>
<td>Select Class</td>		
<td width='250'> <select name='class' >	
...
<td width='250'> <select name='division' >
...
<td>&nbsp;</td>
<tr align='center'>
<td><input type='submit' name='search' value='Search' class='l' /></td>
</tr>";
echo "</table>";
...
$c=$_POST["class"];
$d=$_POST["division"];
$url = "viewstudent1.php?Class=". $c. "&Division=".$d;  //pass selected class and division to viewstudent1
     header("Location: $url");
}
echo "</form>";
