...
include("Connect.php");
$a=$_GET["AlbumId"];
$s="SELECT * FROM album WHERE AlbumId='$a'";	//select album details of requested album id
$r=mysql_query($s);
if($sr = mysql_fetch_array($r))
{
...
?>
	...
	<div id="cnt1"><div class="post">
		  <h1 align="center" class="title">&nbsp;</h1>
				<h1 align="center" class="title"><a href="#" class="style1"><?php echo $albumname; ?></a></h1>
				<p class="byline"></p>
				<div class="entry">
...
//include("Connect.php");
//$a=$_GET["AlbumId"];
$sql="SELECT a.AlbumId,a.AlbumName,p.AlbumId,p.PhotoId,p.Photo FROM album a,gallery p WHERE a.AlbumId='$a' and a.AlbumId=p.AlbumId and p.Photo IS NOT NULL";		//select photo and album details
...
<div class="img-grid">
   ...
   echo '<img class="fancybox" src="gallery/'.$photo.'"  style="width:208px;height:228px">'; //}		//display photo
?>
</li></ul>
</div>
