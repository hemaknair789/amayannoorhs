...
<!-- end header -->
	...
	<div id="cnt1"><div class="post">
		  <h1 align="center" class="title">&nbsp;</h1>
				<h1 align="center" class="title"><a href="#" class="style1">Select User</a></h1>
				<p class="byline"></p>
				<div class="entry">
<?php
...
?>
		...
		<form name="changepwd" method="post" action="">
		  <table align="center" width="284" border="0">
            <tr>
              <td width="129" height="84"><b>Select User</b></td>
              <td width="145"><select name="user">
                  <?php
		$sq="SELECT * FROM login";		//selects the user type whose password is to be changed
	   $rc=mysql_query($sq);
