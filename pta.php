 ...
 <ul>
  ...
  <p>&nbsp;</p>
		...
		<div id="content">
		  ...
		  <div class="post">
				<h1 class="title" align="center"><a href="#">Pta</a></h1>
				<p class="byline"></p>
			<div class="entry">
				<form name="pta" method="post" action="" >
		
		<table align="center" width="530" border="6" background="images/i.jpg">
		<tr><td width="186"><span class="style12">Name</span></td>
		<td width="167"><span class="style12">Designation</span></td>
		<td width="145"><span class="style12">Contact No</span></td>
		</tr>
  ...
  include("Connect.php");
//$id = $_SESSION['din'];
$query = "select * from pta where Status='Active' order by PtaId";	//select active members
...
?>
		...
		<tr><td width="186"><span class="style13"><?php echo $mname; ?></span></td>
		<td width="167"><span class="style13"><?php echo $desig; ?></span></td>
		<td width="145"><span class="style13"><?php echo $phone; ?></span></td>
		</tr>
...
<?php } ?>
  ...
  include("Connect.php");
//$id = $_SESSION['din'];
$query = "select * from news where Status='Active'";		//to display pta details
