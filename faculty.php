 ...
 <ul>
  ...
  <p>&nbsp;</p>
		...
		<div id="content">
		  ...
		  <div class="post">
				<h1 class="title" align="center"><a href="#">Faculty List</a></h1>
				<p class="byline"></p>
			<div class="entry">
				<?php
...
$query = "select * from staff where status='Active' order by Tid ";		//select faculty details of active faculty
$result=mysql_query($query);


	
echo "<form action='' method='post'>"; //form started here
echo "<table border='0' width='500' background='images/i.jpg'>
...
while($row = mysql_fetch_array($result))
  ...
  echo "<td><a href='facultyview.php?Tid=$a'>view details</a></td>";
  echo "</tr>";
  $i++;
  }
echo "</table>";
